    ...
    const costCategories = [
        ...
        },
        {
            ...
            detectors: [
                ...
                {
                    name: "NAT Gateway Egress Cost",
                    id: "nat_gateway_egress_cost",
                    description: "Active NAT gateways with quantified data-processing costs (CloudWatch BytesOut + BytesIn, extrapolated to 30 days at $0.045/GB). Cross-references missing S3 and DynamoDB VPC endpoints in the same VPC as the primary remediation path.",
                    severity: "Medium",
                    savings: "Varies — $0.045/GB eliminated by VPC endpoints",
                },
                {
                ...
                {
                    name: "Missing DynamoDB VPC Endpoint",
                    id: "missing_dynamodb_vpc_endpoint",
                    description: "No DynamoDB Gateway VPC endpoint detected. Lambda and ECS workloads in private subnets hitting DynamoDB through NAT incur $0.045/GB data-processing charges. Gateway endpoints are free and eliminate this cost entirely.",
                    severity: "Low",
                    savings: "$5–100/mo",
                },
                {
        ...
        },
        {
            ...
            detectors: [
                ...
                {
                    name: "Log Group: No Metric Filters",
                    id: "cloudwatch_logs_no_metric_filters",
                    description: "Log groups storing ≥1 GB with zero metric filters defined — stored but never analysed. This is the strongest signal that retention can be reduced aggressively with low operational risk. Pairs with the retention finding to confirm it is safe to act. Reports $0 savings to avoid double-counting with the retention detector.",
                    severity: "Low/Medium",
                    savings: "Corroborating signal — see Log Group Retention finding",
                },
            ],
        },
        {
            ...
            detectors: [
                ...
                {
                    name: "S3 Access Logging Disabled",
                    id: "s3_access_logging_disabled",
                    description: "Buckets without server access logging enabled. Access logs are the prerequisite for confident lifecycle and Intelligent-Tiering decisions — without them, you cannot know object access frequency and any optimisation recommendation is a guess.",
                    severity: "Low",
                    savings: "Enabler — unlocks confident lifecycle and IT decisions",
                },
                {
                    name: "S3 Intelligent-Tiering Not Configured",
                    id: "s3_intelligent_tiering_not_configured",
                    description: "Buckets with no S3 Intelligent-Tiering configuration. IT automatically moves objects between Frequent and Infrequent Access tiers — no lifecycle rules to manage. Typical savings: 40–60% on infrequently accessed data. Enable access logging first to validate access patterns.",
                    severity: "Low",
                    savings: "Varies — typically 40–60% on IA-eligible data",
                },
            ],
        },
        {
